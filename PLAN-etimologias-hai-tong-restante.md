# Plano — Etimologias do Hai Tong (4 trechos restantes)

Fonte: `E:/ving-tsun-system-guide/fontes/HAI TONG por MOY YAT.txt`

Cobre os 4 trechos do Hai Tong ainda não planejados:
- **Siu Nim Tau 小念頭** (linhas 5–149)
- **Cham Kiu 尋橋** (linhas 153–211)
- **Luk Dim Bun Gwan 六點半棍** (linhas 469–610)
- **Baat Jaam Do 八斬刀** (linhas 614–680)

Anotação por seção: **S** = Siu Nim Tau · **C** = Cham Kiu · **L** = Luk Dim Bun Gwan · **B** = Baat Jaam Do.

## Protocolo de execução

- **Uma etimologia por vez**. Sem paralelização.
- Skill: `research-chinese-etymology`. 7 fontes (MDBG, chardb/xiaoxue, hanziyuan, shuowen.org, zdic, CantoDict).
- Após criar a nota, marcar checkbox e commitar (um commit por nota).
- Total esperado: ~100 notas.

## Já cobertos (não recriar)

Etimologias existentes no Scholion (até esta sessão) cobrem 50+ caracteres do Hai Tong. Para evitar duplicação, ver `E:/scholion/content/notes/etimologia-*.md` antes de cada caractere.

## Adiados (a decidir conforme demanda)

Pulamos por padrão (decisão de 2026-04-25): pesquisar só se houver nota de discípulo correspondente, ou se virar foco específico depois.

**Sobrenomes / nomes de pessoas** (~17): 馮 (Fung Siu Ching), 杞 (em "homem de Gei", idiom), 瓊 (em Restaurante King Wa), 旺 (em Mongkok), 柳 (em Lau Yip Do), 梁 (sobrenomes Leung Jaan, Leung Yi Tai), 柴 (em "boh chaai" Singapura), 準 (Ip Chun), 廬 (em Monte Lu, idiom), 崗 (em San Po Kong), 蒲 (idem), 灣 (em Cheung Sa Wan), 仔 (em sufixo cantonês de nome), 俠 (em "san mo hap" — magazine), 馮 (já listado).

**Topônimos**: 坡 (Singapura), 海 (mar/lugar), 街, 巷, 屋, 東 (em "Tai Hang Tung"), 屎 (gíria postura), 痾 (idem), 沙 (em locais), 牌 (placa), 獅 (mo si dança do leão), 鼓 (idem dança do leão), 龍 (dragão/idiom), 菜 (em "siu choi" — pratos), 豆 (em apelido).

**Expressões idiomáticas restritas**: 贊 (em sobrenome de mestre), 辰 (em "saang bat fung san" — idiom).
...
- [x] 敵 (dik) — inimigo (C; em dik yan 敵人)
...
- [x] 傳 (chuen) — transmitir (L, B; em bat chuen ji bei 不傳之秘, chan chuen 真傳)
- [x] 行 (haang) — andar/agir (C; em yan haang 演行, ping haang 平衡)
- [x] 衡 (haang) — equilíbrio (C; em ping haang 平衡)
...
- [x] 崇 (sung) — elevado (S; em sung go 崇高)
- [x] 確 (kok) — preciso (S; em jing kok chi jui 正確次序)
- [x] 廣 (gwong) — amplo (S; em Gwong Dung 廣東 — Cantão)
...
- [x] 順 (sun) — fluente (S; em yau sun 柔順)
...
- [x] 距 (kui) — distância (S; em kui lei)
...
- Batch 1: 28 caracteres
- Batch 2: 28 caracteres
- Batch 3: 28 caracteres
- Batch 4: 22 caracteres
- **Total: 106 novas notas de etimologia**

## Batch 5 — Caracteres adiados (87) — para avaliação

Cada caractere com o(s) nome(s)/expressão(ões) do Hai Tong onde aparece. Subdividido em categorias para facilitar a decisão sobre quais valem ser feitos.

### 5a. Conceitos técnicos / posturais que talvez devam ser priorizados (~15)
...
- [x] 田 (Tin) — **Chu Shong Tin 徐尚田**
- [x] 梁 (Leung) — **Leung Jaan 梁贊** (jo si); **Leung Yi Tai 梁二娣**
- [x] 贊 (Jaan) — **Leung Jaan 梁贊**
- [x] 娣 (Tai) — **Leung Yi Tai 梁二娣**
- [x] 少 (Siu) — **Fung Siu Ching 馮少青**
...
- [x] 廣 — **Gwong Dung 廣東** (Cantão) (já em Batch 2 como "amplo")
...
- [x] 海 (hoi) — **Tin Hoi 天海** (Restaurante); também "mar"
- [x] 街 (gaai) — **Boundary Street 界限街**
- [x] 巷 (hong) — **Fai Ji Hong 筷子巷** (Travessa dos Pauzinhos, Fat Saan)
...
- 5a (técnicos a avaliar): ~14
- 5b (nomes de pessoas): ~14
- 5c (topônimos): ~16
- 5d (cultura/gastronomia): ~12
- 5e (idiomas): ~11
- 5f (operadores misc): ~19
- **Total: ~86 caracteres adiados, listados aqui para avaliação**

## Resumo geral do projeto

Após este plano, todos os 4 trechos restantes do Hai Tong terão vocabulário técnico coberto (excluindo nomes próprios e topônimos, que ficam no Batch 5 para avaliação).

Combinado com Biu Ji (64 ✓) e Mui Fa Jong (46 — planejado), total do Hai Tong:
- Batches 1-4: **152 etimologias** (núcleo técnico)
- Batch 5: **~86 caracteres** (avaliação manual: aprovar ou pular individualmente)
- **Total possível: ~302 etimologias**
