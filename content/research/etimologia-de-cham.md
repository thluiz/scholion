...
summary: "O que 尋 realmente significa — do fio embolado ao ato de medir, buscar e administrar"
...
- [Etimologia de Cham 寻](/notes/etimologia-de-cham-xun/) — decomposição básica do ideograma
- [Cham (尋): tatear com a mão](/notes/cham-tatear-com-a-mao/) — comentário sobre o sentido físico de "procurar"
- [Etimologia de Cham Kiu 尋橋](/notes/etimologia-de-cham-kiu-xun-qiao/) — pesquisa completa com 7 fontes
...
O Duan Yucai dá uma viajada sobre como Xun/Cham pode ser quente e frio ao mesmo tempo de acordo com o texto que ainda não entendi (em aberto), mas por final ele fala: 从工口。从又寸。工口、亂也。又寸、分理之也 — É composto por "gong" e "kou", e "you" e "cun". "Gong" e "kou" significam caos. "You" e "cun" significam dividir e administrar (fazendo a referência cíclica de mão esquerda/direita que mandei semana passada) — Administrar aqui nesse sentido de ordenar, desembaraçar, enfim buscar e medir. (2000 anos depois o Peter Drucker vai dizer que se algo pode ser medido, então pode ser administrado — garoto jovem.)

### O curioso caso de 工口

Achei curioso esse 工口 ser caos e fui pesquisar mais. Parece ser uma gíria da época do Duan Yucai (século XVIII), não é tão comum de encontrar nesse sentido.
...
Nessa matriosca de busca, 工口 vem do Japão. Lá os ideogramas são lidos como *Ero Tic* quando usados como gíria — ele remete ao desenho de katana e o restante fica para a imaginação de cada um.

A leitura usual em japonês é *Kōkuchi*, que é usado para oficina. Não achei como isso foi parar na China de forma pervertida (nesse caso literalmente).
...
- ✓ 22 definições de 尋 — verificadas na [nota de etimologia](/notes/etimologia-de-cham-kiu-xun-qiao/)
Links: [chardb](https://chardb.iis.sinica.edu.tw)

## Não verificados

- ? "Este dicionário é confiável" — referência ao trabalho da Academia Sinica mencionado na conversa. Qual trabalho exatamente?
- ? 工口 como gíria do século XVIII no sentido de caos — precisa de fonte primária
- ? 工口 → ēi luó no MDBG — verificar se a entrada existe de facto ou se é input de comunidade
- ? *Kōkuchi* como leitura japonesa de 工口 para "oficina" — verificar em dicionário japonês
- ? Origem da gíria japonesa 工口 = erótico — verificar se a teoria da katana tem fonte ou é folclore de internet
