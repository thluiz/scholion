---
title: "Etimologia de 奜 (Fei — Fěi / fei2)"
date: '2026-04-22T23:41:44+01:00'
summary: "Análise etimológica de 奜 (Fěi / fei2), caractere raro. chardb: 大 ('grande') e variante de 斐 ('elegante'); sobrenome. Composição: 大 (grande) + 非 (fonético). Sem entrada no Shuowen; atestado em 2 formas bronze: 𢼄鼎 (Zhou Ocidental médio) e 貨系501 (Warring States, Jin). Paronímia fonológica com 菲 e 斐. Sete fontes consultadas."
toc: true
...
**奜** — U+595C · 部首 radical: 大 (dà — grande) [chardb também lista 夂 como radical alternativo no Kangxi] · 總筆畫 strokes: 11 · 注音 zhuyin: ㄈㄟˇ · 拼音 pinyin: fěi / jyutping: fei2

É o Fei do nome [Moy Fei Ming](/notes/moy-fei-ming/).

### Definições

**MDBG**: grande (fěi). Entrada minimalista.

**CantoDict**: (não retornou dados — o site não tem entrada populada para 奜 além da interface de busca).

**chardb Academia Sinica**:
1. 大 (grande)
2. 同「斐」。姓 (mesmo que 斐 — elegante; sobrenome)

Leituras: fěi (principal), fēi (secundária, ambas ambas ㄈㄟˇ / ㄈㄟ).

### Decomposição e formas antigas (hanziyuan)

Composto (análise convencional):
- 大 dà (grande) — semântico
- 非 fēi (fonético)
...
**說文**: (não retornou dados — 奜 não tem entrada no Shuowen de Xu Shen nem no 說文新附 de Xu Xuan).
...
|---------|--------|----------------|
| Zhou Ocidental médio (Xī Zhōu zhōngqī) | Bronze (金文) | 𢼄鼎 (Bì dǐng) |
| Warring States, Jin 晉 | (coleção numismática/cerâmica) | 貨系501 |

Total: 2 formas. Ausência em osso oracular, selo, clerical. Atestação epigráfica extremamente escassa mas pré-imperial.

**說文**: (não retornou dados — sem entrada no Shuowen).
...
**上古音 Chinês Arcaico**:
- 高本漢 Karlgren: (não retornou dados — 查無資料)
...
- **Consenso lacunar**: das 7 fontes consultadas, apenas 3 (MDBG, chardb, xiaoxue) têm dados substantivos. CantoDict, hanziyuan, Shuowen e Shuowen-段注 não retornaram informação. Caractere raro, de documentação filológica escassa.
