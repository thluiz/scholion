...
- title: Three-body problem — Wikipedia
  ...
  kind: wiki
- title: Poincaré and the Three-Body Problem — Wikipedia
  url: https://en.wikipedia.org/wiki/Poincar%C3%A9_and_the_Three-Body_Problem
  kind: wiki
- title: Lagrange point — Wikipedia
  url: https://en.wikipedia.org/wiki/Lagrange_point
  kind: wiki
- title: Karl F. Sundman — Wikipedia
  url: https://en.wikipedia.org/wiki/Karl_F._Sundman
  kind: wiki
- title: The dramatic episode of Sundman — ScienceDirect
  url: https://www.sciencedirect.com/science/article/pii/S0315086009001360
  kind: article
- title: 'From Order to Chaos: The Prize Competition in Honour of King Oscar II — Acta Mathematica'
  url: https://www.actamathematica.org/library/prize-competition/
  kind: article
---
