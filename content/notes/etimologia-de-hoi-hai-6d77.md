...
**海** — U+6D77 · 部首 radical: 水 (shuǐ, água; em posição lateral é 氵) · 總筆畫 strokes: 10 · 注音 zhuyin: ㄏㄞˇ · 拼音 pinyin: hǎi / jyutping: hoi2
...
Composto fonossemântico: 氵 (variante de 水 *shuǐ*, "água" — semântico) + 每 (měi, "cada/sempre" — fonético).
Decomposição: 氵 (semântico) + 每 (fonético — mesma família OC *m-/xm-*).
...
|---------|--------|----------------|-------|
| Zhou Ocidental inicial | bronze | 小臣簋 (×2) | bronze |
| Estados Combatentes — Chu | manuscrito Chu | 包2.147, 郭.窮.10, 郭.性.9 | escrita Chu |
| Estados Combatentes — Qin | selo | 官印0021 | selo Qin |
| Han Oriental | seal | 說文‧水部 (Shuowen, seção 水) | seal pequeno |
| Han Ocidental | clerical | 老子甲後308, 相馬經6下 | clerical |
| Han (datação não especificada) | seal-clerical | 漢印徵 | selo |
| Han Oriental–Jin | bronze-clerical | 東海宮司空槃 | bronze tardio |
| Han Oriental | clerical | 北海相景君銘, 熹.詩.大雅校記 | clerical |
