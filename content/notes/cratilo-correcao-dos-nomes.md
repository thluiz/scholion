---
title: "A correção dos nomes: o problema do Crátilo de Platão"
date: 2026-06-14T01:52:38+01:00
summary: "O Crátilo de Platão funda a pergunta ocidental sobre a linguagem: os nomes são corretos por natureza ou por convenção? Hermógenes, Crátilo e Sócrates disputam, e o diálogo conclui que o real não se conhece pelos nomes, mas pelas coisas."
tags: ["platao", "cratilo", "filosofia-da-linguagem", "filosofia-antiga", "nomes"]
has_commentary: true
sources:
  - title: "Crátilo (Cratylus)"
    author: "Platão"
    year: -360
    publisher: "numeração Stephanus; traduções inglesas consultadas: B. Jowett (1871) e H. N. Fowler (1921)"
    url: "https://www.gutenberg.org/files/1616/1616-h/1616-h.htm"
    kind: book
...
A posição de Hermógenes é o convencionalismo: a correção dos nomes vem inteira do costume e do acordo (*synthēkē*). Não há nome verdadeiro nem falso, só nome em uso. A de Crátilo é o naturalismo: existe um padrão natural (*physei*) que faz um nome certo ou errado, independente do que se combine. Os dois extremos se enfrentam, e Sócrates vai recusar ambos.

### O nome como ferramenta

Sócrates dá o primeiro ponto a Crátilo, contra Hermógenes. Se nomear fosse arbitrário, não existiria nomear bem ou mal, mas existe. Logo o nome tem uma função, e o que tem função é uma ferramenta. Na tradução de Fowler:
...
A parte mais longa e mais estranha do diálogo é uma sequência de etimologias. Sócrates destrincha dezenas de palavras gregas e quase todas revelam, segundo ele, uma mesma visão de mundo: a de que tudo se move. "Deuses", *theoi*, viria de correr:
...
Quando se chega a nomes que não se decompõem em outros, a correção teria de ser imitação direta: as letras imitariam as coisas, o "r" sugerindo movimento, e assim por diante, no que se chama teoria mimética dos nomes primários. Vale uma ressalva de leitura: boa parte dessas etimologias é forçada, e até hoje se discute quanto disso Platão leva a sério e quanto é ironia. O catálogo completo está em [[cratilo-etimologias]].
...
O fecho é o que mais interessa para o problema da linguagem. Mesmo que os nomes carreguem uma teoria do mundo, eles não são via segura para o conhecimento. Quem os inventou podia estar enganado, e aprender pela palavra é herdar o erro de quem a cunhou. Por isso Sócrates pergunta:
...
A mesma intuição reaparece, em outro registro, do outro lado da Eurásia. Onde o *Crátilo* pergunta se os nomes são corretos, Confúcio manda que sejam corrigidos: a [[confucius-rectification-of-names|retificação dos nomes]] (正名) é tarefa de governo, porque nome errado desordena a fala e, no fim da cadeia, deixa o povo sem saber onde pôr as mãos e os pés.
