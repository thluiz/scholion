...
Componentes: 兩戶 (dois 戶 hù — meio-portão/folha única) lado-a-lado
Significado original: portão
Notas hanziyuan: "um portão; de 門; de 鬥 [lutar] em 鬧 [barulho]"
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=門))
