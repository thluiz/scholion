---
title: "Etimologia de 法 (Fat — Fǎ / faat3)"
date: '2026-04-22T10:45:00+01:00'
summary: "Análise etimológica de 法 (Fǎ / faat3), 'lei, método, modelo, dharma'. Forma antiga 灋: 氵 (água) + 廌 (xièzhì, animal mítico que distinguia o certo) + 去 (remover). Shuowen: 刑也 ('punição; nivelado como água'). hanziyuan: 'vau de rio → método'. Sete fontes consultadas."
toc: true
...
Componentes: 氵 *shuǐ* (água) + 去/厺 *qù* (pessoa que parte) + 廌 *zhì* (animal mítico que sabia distinguir o certo do errado).
Significado original: vau de rio (lugar onde se pode atravessar o rio sem afogar-se); daí o sentido derivado de 辦法 "método".
Cadeia gráfica: 法 ← 㳒 ← 灋.
Formas atestadas: Oracle 0 · Bronze 0 (hanziyuan) · Seal 1 (S07090) · Liushutong 0.
