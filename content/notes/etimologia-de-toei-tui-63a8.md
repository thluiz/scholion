...
Componentes: **扌** (mão — semântico) + **隹** (*zhuī*, ave de cauda curta — fonético).
Significado original (Sears): *push, expel; push forward* — empurrar, afastar; impelir.
Exemplo de uso: 推遲 tuī chí (adiar).
Frequência (Sears): 535.
...
- **Romanização Moy Yat "Toei" vs jyutping "teoi"**: a romanização interna da linhagem usa **Toei** enquanto o padrão jyutping acadêmico é **teoi1**. Diferença ortográfica sem impacto fonológico — ambas refletem o mesmo timbre /tʰɵy¹/.
