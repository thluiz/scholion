---
title: "Etimologia de 筷 (Faai — Kuài / faai3)"
date: '2026-05-11T14:38:46+01:00'
summary: "Etimologia de 筷 (faai / kuài / faai3): pauzinho, hashi. Composto fonossemântico de 竹 (zhú, bambu) + 快 (kuài, fonético — 'rápido'). Caractere tardio — ausente do Shuowen e do corpus epigráfico pré-Ming. Substituiu o antigo 箸 (zhù, pauzinho) por tabu fonético: 箸 soava como 住 (zhù, parar) — má sorte para navegantes — então adotou-se 快 (rápido) como fonético, criando 筷. Aparece em Fai Ji 筷子 (pauzinhos) e no topônimo Fai Ji Hong 筷子巷 no Hai Tong por Moy Yat."
toc: true
...
Composto fonossemântico: 竹 (zhú, "bambu" — semântico) + 快 (kuài, "rápido" — fonético).
Decomposição: 竹 (semântico) + 快 (fonético, com substrato semântico positivo — "rápido" carrega conotação auspiciosa de navegação fluida).
