---
title: "Etimologia de 中 (Jung — Zhōng / zung1)"
date: '2026-04-23T22:06:55+01:00'
summary: "Análise etimológica de 中 (Zhōng / zung1). Shuowen: 內也 ('o interior'). Composição: 口 (recinto) + 丨 (linha vertical que atravessa de cima a baixo). 段注 de Duan Yucai corrige versões vulgares que lêem 和也 ('harmonia') — a leitura correta é 內也. Decomposição alternativa do hanziyuan: pictograma original de lançadeira de tear (综); leitura posterior: linha atravessando quadrado que indica centro. Caractere de atestação massiva: 34 oracle bones, 70 bronzes. Nos textos de Moy Yat, aparece em jung sin 中線 (linha central). Sete fontes consultadas."
toc: true
...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=中)**:
1. 裡面；內部 (dentro; interior)
2. 中央；當中 (centro; posição central)
3. 中等 (grau médio)
4. 一半 (metade)
5. 正 (correto; imparcial)
6. 居間的；中介的 (intermediário; mediador)
7. 內心 (coração; mente interior)
8. 內臟 (órgãos internos)
9. 身體 (corpo)
10. 副詞：適合；相當 (advérbio: apropriado; adequado)
11. 方言：好；可以 (dialeto: bom; aceitável)
12. 古代以年齡分等級的服役制 (classificação antiga de idade para corveia)
13. 古代投壺遊戲盛箭籌的器具 (recipiente antigo para fichas no jogo de lançamento de flechas)
14. 中國的簡稱 (forma curta para China)
15. 同「忠」 (mesmo que 忠 — lealdade)
16. 姓 (sobrenome)
17. 符合；適當 (conforme; apropriado)
18. 直相對著；正對 (diretamente alinhado; perfeitamente oposto)
19. 遭受 (sofrer; padecer)
20. 中傷；危害 (caluniar; prejudicar)
21. 間隙 (intervalo; lacuna)
...
Componentes: 口 kǒu (recinto/boca) + 丨 gǔn (linha vertical que passa através)
Variante antiga: 𠁩 (U+20069)
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=中))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=中))
