...
Componentes (Shuowen): 卜 bǔ (divinação) + 中 zhōng (acertar-no-meio)
Significado original: executável, aplicável
Atestação (xiaoxue): abundante oracle bones Shang (甲2324, 鐵116.1, 後1.15.3), bronzes Zhou (大盂鼎 e outros).
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=用))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=用))
