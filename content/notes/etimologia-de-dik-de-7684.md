...
**的** — U+7684 · 部首 radical: 白 · 總筆畫 strokes: 8 · 注音 zhuyin: ㄉㄧˋ / ㄉㄧˊ / ㄉㄜ˙ / ㄉㄧ · 拼音 pinyin: dì / dí / de / dī · jyutping: dik1
...
- *dī*: taxi (empréstimo moderno)
- *dí*: realmente, de verdade
- *dì*: alvo; centro do alvo

**CantoDict**: dik1 (tom 1, alto nível). Moy Yat usa "dik".

**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=的)** (top 8):
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=的))
