...
sources:
  - title: "Scholia"
    url: "https://en.wikipedia.org/wiki/Scholia"
    kind: wiki
  - title: "Marginalia"
  ...
  - title: "Marginalia"
    ...
    year: 1844
    publisher: "Democratic Review / Graham's Magazine"
    kind: article
  - title: "Marginalia"
    author: "Samuel Taylor Coleridge"
    publisher: "Princeton University Press (Bollingen edição em 6 volumes, 1980–2001)"
    kind: book
---
...
**Marginalia** é uma palavra mais nova e mais larga. Latim *marginalis* (relativo à margem), o termo foi cunhado por **Coleridge** no início do século XIX para descrever as próprias anotações que ele rabiscava nos livros que lia. Viraram, postumamente, uma edição em seis volumes. **Edgar Allan Poe** publicou ensaios chamados *Marginalia* nos anos 1840, simulando notas soltas escritas em margens. **Mark Twain** marginaliava seus livros com vingança. **Blake** desenhava nas margens.
