...
É o yau de **yau sun 柔順** ("suave-fluente/maleável"), expressão usada no trecho do **Siu Nim Tao** do *Hai Tong* por Grão-Mestre Moy Yat. A etimologia é central no pensamento clássico — a *flexibilidade da madeira* serve de modelo para a virtude da maleabilidade, valorizada no taoismo (柔弱勝剛強).

### 柔

**柔** — U+67D4 · 部首 radical: 木 (mù, madeira) · 總筆畫 strokes: 9 · 注音 zhuyin: ㄖㄡˊ · 拼音 pinyin: róu / jyutping: jau4

#### Definições

**MDBG**: soft; flexible; supple; yielding; rho (letra grega Ρρ).

**CantoDict**: jau4.

**chardb Academia Sinica** (8 acepções):
1. 木質軟和，可以曲直。也泛稱軟弱，與「剛」相對 (madeira de qualidade flexível, que pode ser dobrada ou retificada; por extensão, "fraco/maleável", oposto de 剛 *gāng* "rígido").
2. 使軟，使弱 (amaciar; enfraquecer).
3. 草木初生；幼嫩 (broto de planta; tenro).
4. 溫和；溫順 (gentil; dócil).
5. 潤澤 (lustroso).
6. 安撫；懷柔 (acalmar; apaziguar — política de pacificação).
7. 漢代侯國名 (nome de estado feudal Han).
8. 姓 (sobrenome).

#### Decomposição e formas antigas (hanziyuan)

Componentes: 木 (mù, "madeira" — semântico) + 矛 (máo, "lança" — fonético).
Significado original: capacidade da madeira de ser curvada ou retificada.
Decomposição: 矛 (fonético) + 木 (semântico, indicando matéria vegetal).
Shuowen (hanziyuan): 木曲直也從木矛聲 ("é a madeira que se curva ou se retifica; do 木, fonético 矛").

#### Shuowen Jiezi (via zdic.net — fallback)

**說文**: 木曲直也。从木矛聲。耳由切 ("É madeira [que se] curva ou retifica. Do 木, fonético 矛. Fanqie 耳由.")
...
- 攝 Division: 流 Liú · 韻 Rhyme: 尤 yóu · 聲 Tone: 平 level · 母 Initial: 日 rì
- 反切 Fanqie: 耳由 ěr-yóu · 等 Grade: 三 third · 開合 Open/Closed: 開 open · 清濁: 次濁 secondary muddy

**上古音 Old Chinese**: (provavelmente *njiw no rhyme 幽 *yōu* — extrapolação a partir das séries Cinco Elementos clássicas; cinco reconstruções não retornadas pela tabela xiaoxue para esta entrada nesta sessão.)
...
- **Aplicação ao Sistema Ving Tsun**: 柔順 *róushùn* "suave-fluente" descreve a qualidade do gesto VT — flexibilidade que segue (順 *shùn*) a força adversária sem se opor frontalmente. A pedagogia VT é explicitamente *柔* (flexível), em contraste com artes marciais "duras" (硬 *yìng*) que privilegiam força frontal. A escolha do caractere preserva a etimologia: o praticante VT é como a madeira — recebe a curva sem se romper, retorna à forma quando cessa a pressão.
- **Filosofia: 柔弱勝剛強**: *Daodejing* 36 (柔弱勝剛強, "o suave-fraco vence o rígido-forte") e 78 (天下莫柔弱於水，而攻堅強者莫之能勝, "nada no mundo é mais maleável que a água, mas para atacar o duro, nada a supera") fundamentam o uso filosófico do 柔. Para a linhagem Moy Yat, esse fundamento é constitutivo — não decoração intelectual, mas matriz da prática.
