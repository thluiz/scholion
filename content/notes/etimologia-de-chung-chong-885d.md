---
title: "Etimologia de 衝 (Chung — Chōng / cung1)"
date: '2026-04-28T00:08:08+01:00'
summary: "Análise etimológica de 衝 (Chōng / cung1), 'via principal, encruzilhada; chocar, irromper'. Composto fono-semântico: 行 (xíng — caminho, semântico) + 童 (zhòng — fonético). Shuowen: 通道也 ('via principal'). Sentidos derivados — 'fazer frente a', 'voltar-se contra', 'irromper' — são extensões pós-Shuowen registradas no 段注 de Duan Yucai. Caractere relativamente tardio: sem atestação em ossos oraculares ou bronzes; primeira forma datável é o pequeno selo do Shuowen, com generalização no clerical Qin–Han. Sete fontes consultadas."
toc: true
...
**MDBG**:
1. (chōng) via principal; ir em linha reta; precipitar-se; chocar (HSK 6)
2. (chòng) poderoso, vigoroso; pungente; voltado para; em vista de
...
1. 通道，大路 (via principal, estrada importante)
2. 通道之交會 (intersecção de passagens, encruzilhada)
3. 要害 (ponto estratégico, lugar crítico)
4. 朝向 (voltar-se para — preposição direcional)
5. 撞擊；急速前進 (colidir; avançar com rapidez)
6. 冒犯；違犯 (ofender; transgredir)
7. 穿透 (perfurar, atravessar)
8. 水流衝擊 (impacto de fluxo de água)
9. 突破 (atravessar com força, romper)
10. (天文) 行星之衝 (oposição planetária — termo astronômico)
11. (五行) 相衝 (choque entre os Cinco Elementos)
12. (中醫) 衝脈 (Meridiano Penetrante, meridiano extraordinário)
13. 突起貌 (aspecto saliente, protuberante)
14. 動的 (dinâmico)
15. 憑藉 (instrumental: por meio de; conforme)
...
- **Leituras**: MDBG distingue só chōng / chòng. chardb registra também **chǒng** (3.º tom) — leitura rara/literária, ausente dos dicionários de uso corrente. Em cantonês, todos os sentidos consolidam-se em **cung1**.
