---
title: "Etimologia de 路 (Lo — Lù / lou6)"
date: '2026-04-26T18:45:30+01:00'
summary: "Análise etimológica de 路 (Lù / lou6), 'caminho, estrada, rota'. Composto fono-semântico: 足 (zú — pé/perna) + 各 (gè — fonético). Shuowen: 道也 ('caminho'). 段注 distingue uso amplo (統言) vs analítico (析言): no *Zhouli*, 道 é caminho ao longo de 澮 (canal), 路 é caminho ao longo de 川 (rio) — distinção institucional. *Erya* e *Mao Zhuan*: 路, 大也 ('路 é grande'). Sem oracle bones; bronze Western Zhou middle (史懋壺). Frequência 280. No Hai Tong: jung lo 中路 (caminho central — vocabulário marcial das três alturas/linhas de ataque). Sete fontes consultadas."
toc: true
...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=路)**:
...
#### Decomposição e formas antigas ([hanziyuan](https://hanziyuan.net/#路))

Componentes: 足/𧾷 zú (pé-perna, semântico) + 各 gè (fonético com associação semântica)
Significado original: estrada
Inglês: road, path, street; journey
Exemplo de uso: 路途 lù tú (jornada)
Frequência: 280 (uso muito frequente)
Shuowen (hanziyuan): 道也從足從各臣鉉等曰言道路人各有適也 (Caminho. De 足 e 各. Os ministros Xu Xuan etc dizem: 'estrada significa que cada pessoa tem o seu destino próprio [人各有適]' — interpretação semântica do componente 各 [cada].)
Formas atestadas: Oracle 0 · Bronze ?
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=路))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=路))
