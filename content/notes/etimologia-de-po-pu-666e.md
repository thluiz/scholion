---
title: "Etimologia de 普 (Po — Pǔ / pou2)"
date: '2026-04-23T12:22:00+01:00'
summary: "Análise etimológica de 普 (Pǔ / pou2), 'universal, geral, difundido'. Forma original Shuowen: 暜 (並 sobre 日). Composição: 並 (lado a lado) + 日 (sol). Shuowen: 日無色也 ('sol sem cor/brilho'). Xu Kai racionaliza: 'quando o sol não tem luz, longe e perto são todos iguais — daí a composição com 並 [lado a lado/igualdade]'. O sentido 'sol obscurecido' estendeu-se para 'todos iguais' → 'universal'. Sete fontes consultadas."
toc: true
...
É o Po do nome de linhagem de Moy Pang Po (Claudio Pamplona).
...
|---------|--------|----------------|
| Shuowen | Pequeno selo (小篆) | 說文‧日部 |
| Han Ocidental | Clerical (隸書) | 流沙簡屯戍16.13 |
| Han Oriental | Clerical | 禮器碑陰 (Lǐqì bēi yīn), 魯峻碑陰 (Lǔ Jùn bēi yīn) |
