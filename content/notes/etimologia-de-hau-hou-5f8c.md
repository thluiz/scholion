---
title: "Etimologia de 後 (Hau — Hòu / hau6)"
date: '2026-05-09T02:32:15+01:00'
summary: "Etimologia de 後 (hau / hòu / hau6): atrás, depois, posterior. Ideograma de associação: 彳 (caminho) + 幺 (pequeno/fio) + 夊 (passo lento) — quem anda devagar fica para trás. Aparece em hau hok 後學 e hau jin 後箭, do Mui Fa Jong no Hai Tong por Moy Yat."
toc: true
...
1. 時間較晚。與「先」、「前」相對 (mais tarde no tempo; opõe-se a 先 "primeiro" e 前 "antes").
2. 位置在後。與「前」相對 (posição posterior; opõe-se a 前 "frente").
3. 落在後面 (ficar para trás).
4. 次序靠近末尾的 (em sequência, próximo ao fim).
5. 將來；未來 (futuro; o que está por vir).
6. 子孫；後代 (descendentes; posteridade).
7. 指弟媳 (referência à esposa do irmão mais novo).
8. 擯棄 (rejeitar; abandonar).
9. 肛門 (ânus).
10. 語氣詞。用於句中或句末，相當於「呵」或「啊」(partícula final; equivalente a "huh" ou "ah").
11. 姓 (sobrenome).

#### Decomposição e formas antigas (hanziyuan)

Componentes: 彳 (chì, caminho/passo curto) + 幺 (yāo, fio único; pequeno) + 夂/夊 (zhǐ/suī, pé virado para baixo, "passo lento").
Significado original: "depois", "atrás".
Decomposição (Sears): "compound 後 from road-left 彳 chì and single-thread 幺 yāo and bottom-foot 夂夊 zhǐ-suī" — com a observação "幺 which may trail behind" (o fio que pode arrastar-se atrás).
Simplificação: 后 = empréstimo fonético do antigo 后 (sovern, "soberano que dá ordens"); o caractere original 後 (depois, pé arrastando um fio) foi substituído pelo homófono no sistema simplificado.
Shuowen (hanziyuan): 遲也從彳幺夊者後也徐鎧曰幺猶躓之也 ("é tardar; do 彳, 幺 e 夊; quem tem 幺 e 夊 fica atrás. Xu Kai diz: 幺 é como tropeçar.").
Formas atestadas: Oracle 0 (Sears) · Bronze 13 · Seal 1 · Liushutong 16.
...
**Han Ocidental**: 魚 *yú* rhyme group (deriva tardia, fora do *hóu* clássico).
**Han Oriental**: 魚 (mantém-se).
