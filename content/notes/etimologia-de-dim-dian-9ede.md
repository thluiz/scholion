...
**點** — U+9EDE · 部首 radical: 黑 (hēi, preto) · 總筆畫 strokes: 17 · 注音 zhuyin: ㄉㄧㄢˇ · 拼音 pinyin: diǎn / jyutping: dim2
...
Composto fonossemântico: 黑 (hēi, "preto" — semântico) + 占 (zhān, "adivinhar/ocupar" — fonético).
Decomposição: 黑 (semântico) + 占 (fonético).
Simplificação moderna: 点 (U+70B9) — substituição de 黑 por 灬 (forma reduzida do componente "fogo").
