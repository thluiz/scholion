...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=借)**:
1. 暫時使用屬於他人的人、財或物品 (usar temporariamente a pessoa, riqueza ou bens de outrem)
2. 把屬於自己的人、財、物暫時給別人使用 (emprestar temporariamente a outros o que é próprio)
3. 幫助 (ajudar; auxiliar)
4. 推重；贊許 (estimar; aprovar)
5. 憑藉；依靠 (apoiar-se em; depender de)
6. 假托；藉口 (pretexto; alegação)
7. 連詞。相當於「假使」、「假設」 (conjunção equivalente a 假使/假設 — se, supondo que)
8. 用同「惜」 (intercambiável com 惜 — lamentar, poupar)
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=借))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=借))
