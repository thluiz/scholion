...
**拿** — U+62FF · 部首 radical: 手 · 總筆畫 strokes: 10 · 注音 zhuyin: ㄋㄚˊ · 拼音 pinyin: ná · jyutping: naa4
...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=拿)**:
...
Componentes de 拏 (forma original): 手 shǒu (mão) + 奴 nú (fonético, "escravo/servo")
Significado original: segurar, puxar
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=拏))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=拏))
