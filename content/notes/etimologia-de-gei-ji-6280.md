...
**技** — U+6280 · 部首 radical: 手 (shǒu — mão) · 總筆畫 strokes: 7 · 注音 zhuyin: ㄐㄧˋ · 拼音 pinyin: jì · jyutping: gei6
...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=技)**:
...
#### Decomposição e formas antigas ([hanziyuan](https://hanziyuan.net/#技))

Componentes: 扌 shǒu (mão, semântico) + 支 zhī (mão segurando galho, fonético com reforço semântico)
Significado original: habilidade
Inglês: skill, ability, talent, ingenuity
Exemplo de uso: 技術 jì shù (tecnologia/técnica)
Frequência: 540 (uso comum)
Shuowen (hanziyuan): 巧也從手支聲 (Perícia. De 手; 支 fonético.)
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=技))
