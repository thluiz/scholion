...
**繫** — U+7E6B · 部首 radical: 糸 · 總筆畫 strokes: 19 · 注音 zhuyin: ㄐㄧˋ / ㄒㄧˋ / ㄙˋ · 拼音 pinyin: jì / xì / sì · jyutping: hai6
...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=繫)**:
...
Componentes: 糸 mì (fio de seda) + 毄 jī (fonético, "bater/golpear")
Significado original: fibras grosseiras
Formas atestadas (xiaoxue): Han Ocidental (蒼頡篇12), Han Oriental (流沙簡·補遺1.11), Wei (魏上尊號奏). Ausência em oracle/bronze — caractere de consolidação Han.
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=繫))
