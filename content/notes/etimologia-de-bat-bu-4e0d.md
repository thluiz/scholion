---
title: "Etimologia de 不 (Bat — Bù / bat1)"
date: '2026-05-09T10:25:55+01:00'
summary: "Etimologia de 不 (bat / bù / bat1): negação clássica e moderna. Pictograma: pássaro voando para cima sem descer (asas e cauda). No Shuowen, '鳥飛上翔不下來也'. O sentido moderno 'não' deriva por empréstimo. Aparece em bat chuen ji bei 不傳之秘 (segredo não transmitido), do Hai Tong por Moy Yat."
toc: true
...
1. 非；不是 (negação; não ser).
2. 副詞。表否定、禁止、不管、不論、不可能、反問或用在句尾表疑問 (advérbio que expressa negação, proibição, indiferença, possibilidade, pergunta retórica; ou em final de frase para pergunta).
3. 助詞。加強語氣和調整音節 (partícula que reforça tom ou ajusta sílabas).
4. Variante de 丕 (grande).
5. Variante de 鄙 (vulgar; baixo).
6. Pássaro subindo em voo.
7. Variante de 否 (não).
8. 夫不: também escrito 鳺鴀 (nome de pássaro).
9. 姓 (sobrenome).
10. Cálice da flor; depois grafado 柎.

#### Decomposição e formas antigas (hanziyuan)

Componente: 不 (caractere simples — pictograma).
Significado original: pássaro em voo ascendente.
Decomposição (Sears): pictograma — pássaro voando para cima, mostrando asas e cauda; a linha horizontal superior representa o céu.
Shuowen (hanziyuan): 鳥飛上翔不下來也從一一猶天也象形 ("é pássaro que voa alto sem descer; do 一; 一 aqui é como céu; pictograma").
