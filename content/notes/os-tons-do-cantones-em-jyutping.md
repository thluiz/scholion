...
Como na nota sobre [os tons do Mandarim](./os-quatro-tons-do-mandarim-em-pinyin.md), descrevo cada tom pelo contorno de Chao (escala 1–5, onde 1 é grave e 5 é agudo) e por um gesto da mão. O exemplo clássico do Cantonês é a sílaba *si*, que como o *ma* do Mandarim cobre os seis tons com palavras reais. Há também um [diagrama dos contornos no Commons](https://upload.wikimedia.org/wikipedia/commons/0/02/Cantonese_tones.svg) que vale a pena olhar antes de seguir.
