...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=斬)**:
...
#### Decomposição e formas antigas ([hanziyuan](https://hanziyuan.net/#斬))

Componentes: 車 chē (carro/quadriga) + 斤 jīn (machado) — com leitura relacionada foneticamente
...
**Atestação em bronzes — 0 (hanziyuan) vs 1 (xiaoxue)**: hanziyuan não registra bronzes; o xiaoxue lista 伯簋 (Zhou médio). Provavelmente o caractere no 伯簋 é lido como 斬 por alguns paleógrafos e como outro grafema por hanziyuan. A leitura do xiaoxue é consistente com a hipótese de Lin Yiguang — se 斬 era abater madeira para fazer carros, o contexto ritualístico/artesanal do bronze é plausível.
