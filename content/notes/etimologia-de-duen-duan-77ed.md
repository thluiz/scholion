...
**短** — U+77ED · 部首 radical: 矢 · 總筆畫 strokes: 12 · 注音 zhuyin: ㄉㄨㄢˇ · 拼音 pinyin: duǎn · jyutping: dyun2
...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=短)**:
1. 不長 (não longo)
...
#### Decomposição e formas antigas ([hanziyuan](https://hanziyuan.net/#短))

Componentes: 矢 shǐ (flecha) + 豆 dòu (vaso ritual; fonético)
Notas de decomposição hanziyuan: "The spear is long the arrow is short" (a lança é comprida; a flecha é curta)
Significado original: curto (como uma corda)
Shuowen (hanziyuan): 有所長短以矢為正從矢豆聲 (Há comprido e curto; a flecha serve de padrão. De 矢, com 豆 como fonético.)
Formas atestadas: Oracle 0 · Bronze 0 · Seal 1 · atestação Qin-Han
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=短))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=短))
