...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=急)**:
1. 急速 (rápido)
...
#### Decomposição e formas antigas ([hanziyuan](https://hanziyuan.net/#急))

Componentes (forma corrente 急): 心 xīn (coração) + 彐+勹 (elemento superior que é, na análise hanziyuan, uma evolução cursiva de 及 jí)
Componentes (forma Shuowen 㤂): 及 jí (alcançar, com pessoa + mão — fonético) em cima + 心 em baixo
Significado original: urgente
Shuowen (hanziyuan): 褊也從心及聲 (Apertado. De 心, com 及 como fonético.)
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=急))
