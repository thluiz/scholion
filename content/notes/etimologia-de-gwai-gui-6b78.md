---
title: "Etimologia de 歸 (Gwai — Guī / gwai1)"
date: '2026-04-24T20:10:47+01:00'
summary: "Análise etimológica de 歸 (Guī / gwai1), 'retornar, voltar para casa'. Shuowen: 女嫁也 ('o casamento da mulher' — entendido como 'retornar à casa do marido'). Composto: 止 (pé) + 婦 (mulher — reduzido) + 𠂤 (fonético). 段注 de Duan Yucai corrige: não é apenas sobre mulheres casando — é o modelo geral de 'retornar a casa' aplicado a toda vinda-para-si. Simplificado: 归. Atestado em oracle bones Shang — vocábulo direcional-relacional antigo. No Hai Tong, aparece em gwai sau 歸守 ('retornar e guardar' — função de Siu Nim Tau). Sete fontes consultadas."
toc: true
...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=歸)**:
...
Componentes: 止 zhǐ (pé) + 婦 (mulher, reduzido) + 𠂤 duī (montículo; fonético)
Significado original: casamento/retorno para casa
Formas atestadas (xiaoxue): abundantes — oracle bones Shang (甲3342, 鐵81.3), bronzes Zhou múltiplos.
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=歸))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=歸))
