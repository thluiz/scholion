...
**境** — U+5883 · 部首 radical: 土 (tǔ — terra) · 總筆畫 strokes: 14 · 注音 zhuyin: ㄐㄧㄥˋ · 拼音 pinyin: jìng · jyutping: ging2
...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=境)**:
...
#### Decomposição e formas antigas ([hanziyuan](https://hanziyuan.net/#境))

Componentes: 土 tǔ (terra, semântico) + 竟 jìng (terminar/limite, fonético com associação semântica)
Significado original: fronteira
Inglês: boundary, frontier; area, region
Exemplo de uso: 境界 jìng jiè (domínio/limite)
Frequência: 686 (uso especializado)
Shuowen (hanziyuan): 疆也從土竟聲經典通用竟 (Fronteira. De 土; 竟 fonético. Nos textos clássicos, usa-se 竟 [intercambiável].)
Formas atestadas: Oracle 0 · Bronze 0
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=境))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=境))
...
- **竟** (peça musical termina; limite genérico)
- **疆** (jiāng — fronteira aristocrática Zhou)
- **界** (jiè — limite, divisão; cf. 境界)
