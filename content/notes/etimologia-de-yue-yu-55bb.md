...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=喻)**:
1. 說明 (explicar)
2. 知曉，明白 (saber; compreender)
3. 比喻，比方 (metáfora; analogia)
4. 諫 (advertir; remonstrar)
5. 姓 (sobrenome)
6. 通『愉』。愉快 (intercambiável com 愉 — alegre)
7. 同『諭』。告知 (mesmo que 諭 — informar)
8. 曉喻；開導 (esclarecer; guiar)
...
Componentes de 喻: 口 kǒu (boca) + 俞 yú (fonético, "consentir/responder")
Componentes de 諭: 言 yán (fala) + 俞 yú (fonético)
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=喻))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=喻))
