---
title: "Etimologia de 貴 (Bei — Guì / gwai3)"
date: '2026-04-22T23:27:40+01:00'
summary: "Análise etimológica de 貴 (Guì / gwai3), 'precioso, nobre, caro'. Composto fonossemântico: 貝 (concha/cáuri/moeda) + 臾 (variante antiga de 蕢, fonético). Shuowen: 物不賤也 ('o que não é vil/barato'). A concha como unidade de valor: o que tem valor não é vulgar. Forma antiga 䝿 passou a 貴 na escrita clerical. Sete fontes consultadas."
toc: true
...
É o Bei do nome [Moy Dak Bei](/notes/moy-dak-bei/).
...
1. 價格高 (preço alto; caro)
2. 社會地位高 (de alta posição social; nobre)
3. 重要 (importante)
4. 崇尚，重視 (estimar; valorizar)
5. 敬重，尊重 (respeitar; honrar)
6. 欲，想要 (desejar; querer)
7. 敬辭，猶「尊」 (honorífico, equivalente a 尊 — "honrado")
8. 地名 (topônimo)
9. 姓 (sobrenome)
...
Significado original (hanziyuan): "expensive" (caro).
Sentidos em inglês: "expensive, costly, valuable".
Exemplo de uso: 尊貴 zūnguì (honorável).
Frequência: 745 (comum).
Nota de decomposição (Sears): 貫 (guàn, atar moedas) e 貴/䝿 provavelmente têm origem comum.
Shuowen (hanziyuan): 物不賤也從貝臾聲臾古人蕢 ("o que não é barato; de 貝 com 臾 como fonético; 臾 é a forma antiga de 蕢").
Regras aplicadas (Sears): B004 贝貝.
Formas atestadas: Oracle 0 · Bronze 0 · Seal 1 (S04578) · Liushutong 20 (L21674–L21687, L36307–L36312).
