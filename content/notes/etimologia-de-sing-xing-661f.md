...
Forma do Shuowen (曐, original): 晶 (jīng, "três estrelas brilhando" — pictograma de céu noturno) + 生 (shēng, fonético).
Forma corrente 星: abreviação onde os três círculos de 晶 foram reduzidos a um único 日 (sol/disco brilhante).
