...
**線** — U+7DDA · 部首 radical: 糸 · 總筆畫 strokes: 15 · 注音 zhuyin: ㄒㄧㄢˋ · 拼音 pinyin: xiàn · jyutping: sin3
...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=線)**:
1. 同「綫」，縷也 (o mesmo que 綫 — fio, filamento)
2. 閹割 (castração)
3. 姓 (sobrenome)

#### Decomposição e formas antigas ([hanziyuan](https://hanziyuan.net/#線))

Componentes: 糸 mì (fio de seda/tecido) + 泉 quán (fonético, "nascente")
Significado original: fio, linha
Shuowen (hanziyuan): 古文綫 (Forma antiga de 綫.)
Formas atestadas: Oracle 0 · Bronze 0 · Seal 1 (S09732) · Liushutong 5
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=線))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=線))
