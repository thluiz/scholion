...
Componente: 弓 (pictograma único)
Significado original: arco (instrumento de tiro)
Notas hanziyuan: "um arco"
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=弓))
...
1. **王弓** (wáng gōng) — arco real — para penetrar armadura/couraça (射甲革甚質).
2. **弧弓** (hú gōng) — arco curvo (mais dobrado) — idem.
3. **夾弓** (jiā gōng) — arco duplo — para caça de aves e bestas (射干侯鳥獸).
4. **庾弓** (yǔ gōng) — arco celeiro — idem caça.
5. **唐弓** (táng gōng) — arco Tang — para instrução de arquearia (授學射者).
6. **大弓** (dà gōng) — arco grande — idem instrução.
