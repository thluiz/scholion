---
title: "Etimologia de 磨 (Mo — Mó / mo4)"
date: '2026-04-23T12:15:00+01:00'
summary: "Análise etimológica de 磨 (Mó / mo4, também mò), 'moer, polir, afiar, mó'. Composto fono-semântico: 石 (pedra, semântico) + 麻 (má — cânhamo, fonético via 靡). Shuowen registra a forma 䃺 (石+靡) com o sentido 'mó de pedra'; 磨 é simplificação posterior. Duan Yucai explica a divisão tonal: 平聲 mó (moer, polir) vs 去聲 mò (a mó, o moinho). Sete fontes consultadas."
toc: true
...
É o Mo do nome de linhagem de Moy Mo Lei (Rodrigo Moreira).
...
**MDBG**:
- **mó** (HSK 6): esfregar, moer, polir, afiar, desgastar, extinguir, perder tempo, incomodar, insistir
- **mò**: mó, pedra de moer, girar
