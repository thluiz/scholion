---
title: "Etimologia de 迪 (Dik — Dí / dik6)"
date: '2026-05-09T10:52:54+01:00'
summary: "Etimologia de 迪 (dik / dí / dik6): caminho, guiar, conduzir. Composto fonossemântico de 辵/辶 (caminhar) + 由 (yóu, fonético). No Shuowen, '道也' (caminho/Via) — quase sinônimo de 道 mas com componente cinético explícito. Aparece em kai dik 啟迪 (abrir e guiar), do Siu Nim Tao no Hai Tong por Moy Yat. Par com 啟 — par pedagógico denso."
toc: true
...
1. 道，道理 (caminho; princípio).
2. 引導，開導 (guiar; conduzir pedagogicamente).
3. 蹈，實踐 (pisar; praticar).
4. 動，作 (mover; atuar).
5. 任用；進用 (designar; empregar).
6. 進，前進 (avançar; progredir).
7. 跟從；遵循 (seguir; obedecer).
8. 行，出奔 (viajar; fugir).
9. 助詞 (partícula auxiliar — sem sentido pleno).
10. 姓 (sobrenome).

#### Decomposição e formas antigas (hanziyuan)

Componentes: 辵/辶 (chuò, "caminhar/movimento" — semântico) + 由 (yóu, "de/através" — fonético).
Significado original: caminho; guiar.
Decomposição: 辶 (semântico, indica movimento) + 由 (fonético).
Shuowen (hanziyuan): 道也從辵由聲 ("é caminho; do 辵, fonético 由").
