---
title: "Etimologia de 拳 (Kuen — Quán / kyun4)"
date: '2026-04-22T18:04:03+01:00'
summary: "Análise etimológica de 拳 (Quán / kyun4), composto fonossemântico: 手 (mão) + 龹 (fonético, juàn). Shuowen: 手也 ('a mão'). 段注 de Duan Yucai esclarece: 卷之爲拳 — 'enrolada, torna-se 拳'. Cita o Liji Tan Gong: 执女手之拳然 ('segurar a tua mão no seu [estado] enrolado'). Cognato de 卷 (curvar/enrolar); o sentido marcial é derivado do gesto de fechar a mão sobre si mesma. Oito fontes consultadas."
toc: true
...
- title: 說文解字 (shuowen.org)
  ...
  kind: wiki
- title: 漢典 (zdic.net) — 段玉裁注
  url: https://www.zdic.net/hans/%E6%8B%B3
  kind: wiki
- title: Wiktionary
...
1. 手 (mão)
2. 屈指捲握的手，即拳頭 (mão com os dedos dobrados e cerrados, i.e. o punho)
3. 力氣；勇力 (força física; coragem marcial)
4. 拳術，一種徒手的武術 (arte do punho; arte marcial desarmada)
5. 愛 (afeição)
6. 捲曲；屈曲 (enrolar; curvar)
7. 弩弓 (besta, arco mecânico)
8. 量詞 (classificador — para socos e objetos do tamanho do punho)
9. 姓 (sobrenome)
...
Significado original (hanziyuan): "fist, boxing" (punho; arte do punho).
Shuowen (hanziyuan): 手也從手龹聲 ("a mão; de 手 com 龹 como fonético").
