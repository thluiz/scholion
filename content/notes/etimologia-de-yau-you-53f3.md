...
Composto ideográfico: 又 (yòu, "mão direita" — semântico-fonético, era o caractere original para "mão direita" antes da diferenciação) + 口 (kǒu, "boca" — semântico).
Imagem composta: mão e boca ajudando-se mutuamente (gesto e palavra em coordenação).
