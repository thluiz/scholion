...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=正)** (sumário):
1. 中央；不偏 (centrado; não-enviesado)
2. 合乎準繩規則 (conforme norma)
3. 端正；公道 (reto; imparcial)
4. 純；不雜 (puro; não misto)
5. 善；好 (bom; virtuoso)
6. 改正；糾正 (corrigir)
7. 使端正；校準 (retificar; alinhar)
8. 治；掌管 (governar; administrar)
9. 治罪 (punir conforme lei)
10. 決定；判斷 (determinar; decidir)

#### Decomposição e formas antigas (hanziyuan)

(hanziyuan não consultado; dados via Shuowen/xiaoxue)

Componentes: 止 zhǐ (pé/parar) + 一 yī (um, horizontal)
Significado original: correto, reto
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=正))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=正))
