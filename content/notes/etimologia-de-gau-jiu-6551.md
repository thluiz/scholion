...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=救)**:
...
#### Decomposição e formas antigas ([hanziyuan](https://hanziyuan.net/#救))

Componentes: 攵/攴 pū (ação-golpe; mão com vara) + 求 qiú (fonético, "procurar/buscar"; originalmente pictograma de pele com pelos — casaco)
Significado original: salvar (vide nota "see 求" na entrada hanziyuan)
Shuowen (hanziyuan): 止也從攴求聲 (Parar/impedir. De 攴, com 求 como fonético.)
Formas atestadas: Oracle 0 · Bronze vários · Seal 1 · abundante Warring States
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=救))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=救))
