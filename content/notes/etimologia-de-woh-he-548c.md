---
title: "Etimologia de 和 (Woh — Hé / wo4)"
date: '2026-04-23T12:42:47+01:00'
summary: "Análise etimológica de 和 (Hé / wo4), 'harmonia, paz, e/com, somar, afinar'. Composto fono-semântico: 口 (kǒu — boca, semântico) + 禾 (hé — grão de cereal, fonético). Shuowen lemma: 咊 (forma arcaica) — 相譍也 ('corresponder mutuamente'). A forma 龢 (flauta de Pan) é caractere irmão: 和 (口 + 禾) foi especializado para 'resposta vocal harmônica', 龢 (龠 + 禾) para 'harmonia musical de instrumentos'. Uso moderno como 'e/com' é extensão Han. Sete fontes consultadas."
toc: true
...
É o Woh do nome kung fu de Pedro Ivo Porfírio ([Moy Yi Woh](/notes/moy-yi-woh/)).
...
5. 和諧；協調 (harmonia; coordenação)
6-7. (harmonia ampliada, relacionamentos gentis)
8. 和順；平和 (ameno; pacífico)
9. 和睦；融洽 (harmonioso; cordial)
10. 和解；和平 (reconciliação; paz)
11-14. (outros sentidos relacionais)
15. 兩個以上的數相加的結果稱和 (soma de dois ou mais números — em matemática)
16-24. (acepções adicionais: temperar, misturar, acalmar)
25. 介詞 (preposição: "e, com")
26-29. (leituras secundárias huó, huò, hú, hè para ações específicas)
30. 姓 (sobrenome)
