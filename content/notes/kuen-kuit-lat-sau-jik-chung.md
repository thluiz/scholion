...
has_commentary: true
sources:
- title: 'PMYVTIM 2017 — Programa de Mestrado (Siu Nim Tau), §F3.2.1.3 — Clã Moy Jo Lei Ou'
  kind: book
...
甩手 é "a mão que se solta"; 直衝 é "o avanço em linha reta". A leitura corrente: quando a mão se solta, o impulso reto avança. Não há intervalo entre soltar e atacar. Perdido o contato, o gesto já vai à frente pela linha mais curta, sem recolher nem rearmar.
