...
Composto fonossemântico: 隹 (zhuī, "ave" — semântico) + 离 (lí, fonético).
Decomposição: 隹 (semântico) + 离 (fonético).
A simplificação moderna 离 (U+79BB) usa apenas o componente fonético, descartando o radical aviano — coerente com o sentido moderno "separar/partir", que não tem relação com aves.
