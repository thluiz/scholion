...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=兄)**:
...
#### Decomposição e formas antigas ([hanziyuan](https://hanziyuan.net/#兄))

Componentes: 儿 ér (pessoa, forma de andar) + 口 kǒu (boca)
Significado original: irmão mais velho (segundo hanziyuan; mas ver correção de 段玉裁 abaixo)
Notas hanziyuan: "aquele que fala / o que faz o falar"
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=兄))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=兄))
