---
title: "Etimologia de 鑰 (Yeuk — Yào / joek6)"
date: '2026-04-22T23:56:43+01:00'
summary: "Análise etimológica de 鑰 (Yào / joek6), 'chave, fechadura'. Composto fonossemântico: 金 (metal) + 龠 (fonético, flauta-de-pan). Sem entrada no Shuowen de Xu Shen. Sentido original: ferrolho de porta (同 𨳲); depois: chave, fechadura, ponto crucial. Forma simplificada moderna 钥 substitui 龠 por 月 como fonético. Sete fontes consultadas."
toc: true
...
**鑰** — U+9470 · 部首 radical: 金 (jīn — metal) · 總筆畫 strokes: 25 · 注音 zhuyin: ㄧㄠˋ / ㄩㄝˋ · 拼音 pinyin: yào / yuè · jyutping: joek6

É o Yeuk do nome [Moy Ke Yeuk](/notes/moy-ke-yeuk/).
...
Significado original (hanziyuan): "lock" (fechadura).
Sentidos em inglês: "key; lock".
Exemplo de uso: 鑰匙 yàoshi (chave).
Frequência: 2595.
Shuowen (hanziyuan): (não retornou dados — 鑰 não tem entrada própria no Shuowen).
Regras aplicadas (Sears): A287 钥[鑰], "phonetic-phonetic 月龠" — variante fonética por substituição de fonético.
Formas atestadas: Oracle 0 · Bronze 0 · Seal 0 · Liushutong 0 — ausência completa em todos os corpora arqueológicos.
...
- **Reconstrução OC lacunar**: apenas Wang Li oferece reconstrução (*ʎ·ǐauk, grupo 藥). Karlgren, Dong Tonghe, Zhou Fagao, Li Fanggui e Zhengzhang não reconstroem — caractereístico de caracteres tardios.
...
- **Leitura no nome kung fu**: a romanização "Yeuk" reflete o jyutping joek6 (cantonês) — o nome [Moy Ke Yeuk](/notes/moy-ke-yeuk/) usa a leitura cantonense do tom de entrada (入聲). A leitura mandarim é yào. A semântica do nome é "chave/acesso".
