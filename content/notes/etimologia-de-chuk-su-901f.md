...
**chardb [Academia Sinica](https://chardb.iis.sinica.edu.tw/search.jsp?stype=1&q=速)**:
1. 迅速 (veloz; rápido)
...
#### Decomposição e formas antigas ([hanziyuan](https://hanziyuan.net/#速))

Componentes: 辶 chuò (caminhar) + 束 shù (feixe; amarrar; fonético)
Significado original: rápido
Shuowen (hanziyuan): 疾也從辵束聲 (Rápido. De 辵, com 束 como fonético.)
Formas atestadas: Oracle presentes · Bronze presentes · Seal 1 · variantes Warring States
...
#### Evolução de formas ([xiaoxue yanbian](https://xiaoxue.iis.sinica.edu.tw/yanbian?char=速))
...
#### Fonologia ([xiaoxue shangguyin](https://xiaoxue.iis.sinica.edu.tw/shangguyin?char=速))
