---
title: "Etimologia de 掌 (Jeung — Zhǎng / zoeng2)"
date: '2026-04-22T17:59:28+01:00'
summary: "Análise etimológica de 掌 (Zhǎng / zoeng2), 'palma da mão'. 手 (mão, semântico) + 尚 (fonético). Caractere tardio — primeira atestação nos Estados Combatentes (selo). O sentido 'administrar, governar' é extensão metafórica de 'ter na palma da mão'. Sete fontes consultadas."
toc: true
...
Componentes: 手 *shǒu* (mão, semântico) + 尚 *shàng* (fonético — sentido autônomo: "ainda; valorizar").
Significado original: palma da mão.
Shuowen (hanziyuan): 手中也從手尚聲 ("O meio/centro da mão. De 手 (mão); 尚 é o fonético.")
Formas atestadas: Oracle 0 · Bronze 0 · Seal 1 (S08813) · Liushutong 5.
