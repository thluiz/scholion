...
1. 刺繡和繪畫設色，五彩俱備 (bordado combinado com pintura colorida; as cinco cores completas).
2. 刺繡。用絲線等在布帛上刺成花紋圖像 (bordar; usar fios de seda no tecido para formar imagens com padrões).
3. 有彩色花紋的絲織品 (têxtil de seda com padrão colorido).
4. 華麗的；精美的 (ornado; refinado).
5. 姓 (sobrenome).

#### Decomposição e formas antigas (hanziyuan)

Componentes: 糸 (mì, "fio de seda" — semântico) + 肅 (sù, fonético).
Significado original: bordar.
Decomposição: 糸 (semântico) + 肅 (fonético).
Variantes: 綉 (forma simplificada do tradicional, usada em alguns contextos); simplificado moderno 绣 (U+7EE3).
Shuowen (hanziyuan): 五采備也從糸肅聲 ("é as cinco cores completas; do 糸, fonético 肅").
Formas atestadas: Oracle 0 · Bronze 0 · Seal 1 · Liushutong 2.
