---
title: "Etimologia de 敵 (Dik — Dí / dik6)"
date: '2026-05-09T03:58:46+01:00'
summary: "Etimologia de 敵 (dik / dí / dik6): adversário, inimigo, igual em força. Composto fonossemântico de 攴 (golpear/tap) + 啻 (chì, fonético). No Shuowen, 'inimigo'; Duan Yucai aprofunda — 'aquele que é igual e por isso pode adversariar'. Aparece em dik yan 敵人 (adversário), do Cham Kiu no Hai Tong por Moy Yat."
toc: true
...
**敵** — U+6575 · 部首 radical: 攴/攵 (pū, golpear) · 總筆畫 strokes: 15 · 注音 zhuyin: ㄉㄧˊ · 拼音 pinyin: dí / jyutping: dik6
...
Componentes: 攴/攵 (pū, "golpear" — semântico) + 啻 (chì, "apenas/somente" — fonético).
Significado original: inimigo (especificamente: aquele que iguala em força e por isso adversaria).
Decomposição: 攴 (semântico, ato de golpear) + 啻 (fonético).
Shuowen (hanziyuan): 仇也從攴啻聲 ("é inimigo; do 攴, fonético 啻").
...
**上古音 Old Chinese**: (provavelmente *deːk no rhyme 錫 *xī*; cinco reconstruções não retornadas pela tabela xiaoxue para esta entrada nesta sessão.)
...
- **敵 vs. 仇 vs. 讎**: três caracteres clássicos para "adversário/inimigo", com nuances:
  - 敵 *dí*: aquele que é *igual em força* (par adversário).
  - 仇 *qiú*: par/cônjuge — sentido amoroso ou hostil; o que se enfrenta.
  - 讎 *chóu*: ódio/vingança específica.
...
- **Aplicação ao Sistema Ving Tsun**: 敵人 *dik6 jan4* "adversário" no vocabulário VT designa especificamente o praticante que enfrentamos no Chi Sau ou no combate. A escolha do caractere 敵 (em vez de 仇 ou 讎) preserva a etimologia "par equivalente": no Chi Sau, o adversário é literalmente o *outro* que permite ao praticante medir-se. A abolição do 敵 aboliria o próprio kung fu — não há autodesenvolvimento sem o par que se enfrenta. O respeito ao 敵 é, portanto, condição técnica e ética da arte.
