---
url: "https://posthog.com/blog/brand?ref=dailydev"
captured_at: "2026-09-25T18:48:45+01:00"
...
This was the most important conversation [Tim](https://posthog.com/community/profiles/27730) and I had before launching PostHog.
...
That's why we set out to create a website and brand that felt both unique and intentional, including a [public handbook](https://posthog.com/handbook) that explained what we were doing, why, and how.
...
One of the most important things we did was to [create an Ideal Customer Profile](https://posthog.com/newsletter/ideal-customer-profile-framework).
...
*   **We chose a transparent, flexible pricing model.** It's more complex, but also [much better value](https://posthog.com/blog/analytics-pricing). We’ve found technical users tolerate a little more complexity if it helps them save money, and only pay for what they use.
    
*   **We focused on power user features**, such as [SQL access](https://posthog.com/docs/sql) and a [built-in data warehouse](https://posthog.com/blog/data-warehouse-at-posthog), so technical people can get to the underlying data and debug things.
    
*   **We redesigned our entire UX** to have more flexibility, greater information density, and a dark mode. We want PostHog to [look like a dev tool](https://posthog.com/blog/posthog-as-a-dev-tool), not an analytics product.
...
But we soon realized we just love shipping new features. After our first [hackathon](https://posthog.com/newsletter/hackathons), we wound up with session replay – i.e. a new feature big enough to be its own product. It took off and this resulted in our current multi-product approach.
...
*   The frequency and style with which you [email your customers](https://posthog.com/blog/how-we-built-email-onboarding), for marketing, product updates or your [activation](https://posthog.com/product-engineers/activation-metrics) flow.
*   The kind of people you hire into [customer success](https://posthog.com/blog/customer-success-at-posthog) or sales.
...
To give you an example, we built a [merch store](https://posthog.com/merch):
