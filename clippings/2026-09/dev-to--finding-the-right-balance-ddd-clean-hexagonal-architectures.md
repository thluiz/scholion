...
captured_at: "2026-09-25T01:24:34+01:00"
...
Although the title might suggest I’m here to tell you exactly how to structure your application, that’s not my goal. Instead, I’ll focus on my personal experiences, choices, and the reasoning behind the approaches I’ve taken when building my apps. This doesn't mean you should structure things the same way, but since many of my friends have asked me about it, I thought I’d try to explain the architecture we use in [TimeMates](https://github.com/timemates/app) (P.S: personal project that I make with my mates; upd: it's almost 2026 and it's still not finished :D).

### [](#smart-terminology)Smart terminology
...
*   **presentation**
*   _domain_ (optional in Google's opinion)
*   **data**
...
### [](#domaindriven-design)Domain-driven Design
...
You can read more about semantic typing in my article — [Semantic Typing We Ignore](https://dev.to/y9vad9/semantic-typing-we-ignore-i0d).
...
##### [](#anemic-domain-entities)Anemic Domain Entities
...
##### [](#ignoring-ubiquitous-language)Ignoring Ubiquitous Language
...
[![Visualisation](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fdu61takk1a8evfukzop4.png)](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fdu61takk1a8evfukzop4.png)
...
##### [](#incorrect-mental-model)Incorrect mental model
...
*   [Telegram](https://t.me/vadymlog)
*   [Twitter](https://twitter.com/y9vad9/)
*   [LinkedIn](https://linkedin.com/in/y9vad9/)
