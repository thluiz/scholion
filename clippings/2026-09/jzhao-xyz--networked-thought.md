---
url: "https://jzhao.xyz/posts/networked-thought"
captured_at: "2026-09-25T17:11:43+01:00"
...
We live in an information age. The amount of data we produce far outweighs what we consume, so much so that it has extended far beyond our ability to make meaningful use of it. Even our modern day [search](https://jzhao.xyz/thoughts/search) systems seem to be falling apart under the stress of today’s overwhelming flow of data with the quality of our search engines degrading from all of the SEO hacks, paid advertiser content, and clickbait headlines.

Over the past year, I’ve slowly found processes that have worked well in creating a little curated corner of the [Internet](https://jzhao.xyz/thoughts/Internet), rich with wonderfully curious people exploring exciting ideas.
...
This is not because I don’t like order, but because I think **a dash of chaos and [entropy](https://jzhao.xyz/thoughts/entropy) is good for new ideas**. They help connect two separate ideas that you normally would not have associated with each other, and to imagine the ‘what if’ more frequently.
...
My goal with a digital garden is not purely as an [organizing system](https://jzhao.xyz/thoughts/organizing-system) and information store (though it works nicely for that). I want my digital garden to be a playground for new ways ideas can connect together. As a result, existing formal organizing systems like Zettelkasten or the hierarchical folder structures of Notion don’t work well for me. There is way too much upfront friction that by the time I’ve thought about how to organize my thought into folders categories, I’ve lost it.

Many try to organize their lives through note taking. There is a classic “top down” vs “bottom up” design tension projected onto how people take notes. Some people trust their ability to predict the future, they want top-down, they want to pave the paths in the garden. Others (normally those that have tried and failed) don’t trust their own ability to predict the future, they want to make it possible for the cows to roam safely, then pave the [desire paths](https://jzhao.xyz/thoughts/desire-paths) after they form.

This is the problem with the file cabinet: it focuses on efficiency of access and [interoperability](https://jzhao.xyz/thoughts/interoperability) rather than generativity and creativity. Thinking is not linear, nor is it [hierarchical](https://jzhao.xyz/thoughts/A-City-is-not-a-Tree). In fact, not many things are linear or hierarchical at all. Then why is it that most tools and thinking strategies assume a nice chronological or hierarchical order for my thought processes? The ideal tool for thought for me would embrace the messiness of my mind, and organically help insights emerge from chaos instead of forcing an artificial order. A [rhizomatic, not arboresecent](https://jzhao.xyz/thoughts/rhizomatic-vs-arborescent), form of note taking.

> The garden is the web as [topology](https://jzhao.xyz/thoughts/search#internet-topology-as-shaped-by-search-engines). Every walk through the garden creates new paths, new meanings, and when we add things to the garden we add them in a way that allows many future, unpredicted relationships.
> 
> ([The Garden and the Stream](https://jzhao.xyz/thoughts/the-garden-and-the-stream))
...
I, by and large, write for myself. [Writing](https://jzhao.xyz/thoughts/writing), for me, is a form of [knowledge distillation](https://jzhao.xyz/thoughts/knowledge-distillation). It helps to clarify my thinking and condense my knowledge so I can easily articulate it to others. If done well, I have a **shareable representation of my thoughts** that I can send out into the world and people can respond. Even for my most half-baked thoughts, this helps me create a feedback cycle to strengthen and fully flesh out that idea.
...
It’s the act of creating ‘newer’ work from saplings, mostly longer form essays, projects, etc. At this stage, thoughts and ideas have matured enough to be able to share and collaborate. Right now, traditional ‘[tools for thought](https://jzhao.xyz/thoughts/tools-for-thought)’ are not great for this aspect, lacking the ability to publish, edit, and share notes with others.
...
Through tending to this garden [in public](https://jzhao.xyz/thoughts/building-in-public), I hope to show my success, failures, and everything in between and offer it as an open garden to learn from for anyone who stumbles upon it in the future. If just one person is inspired by it, learns from a mistake I made, or builds off of my work, then I would consider this garden a success.
...
![](https://jzhao.xyz/thoughts/images/garden-bird.png) _‘Everyone tends his or her own little [epistemological](https://jzhao.xyz/thoughts/epistemology)’ garden, growing ideas from seed and sharing them with anyone who comes by._ [Image Source](https://www.are.na/block/2175982)

* * *

![](https://jzhao.xyz/thoughts/images/chestnut-cake.png)
