...
captured_at: "2026-09-25T21:15:40+01:00"
...
[![](https://swizec.com/assets/giphygif-0c8aad-DxrX2iEa.gif)](https://swizec.com/assets/giphygif-0c8aad-DxrX2iEa.gif)

The trick is to realize this is normal. If you're here, it means the software is working! Fixing this stuff is the job.

## [Good architecture emerges](#good-architecture-emerges)
...
[![Code as dependency graph](https://swizec.com/_vercel/image?url=%2Fassets%2FCode-as-dependency-graph-d97j3b-CP9K8Ck1.png&w=960&q=75)](https://swizec.com/assets/Code-as-dependency-graph-d97j3b-CP9K8Ck1.png)
...
### [The dependency matrix](#the-dependency-matrix)
...
[![Dependency matrix of Mozilla before and after a refactor](https://swizec.com/_vercel/image?url=%2Fassets%2FDependency-matrix-of-Mozilla-before-and-after-a-refactor-e760e8-CWCNvB-d.jpeg&w=960&q=75)](https://swizec.com/assets/Dependency-matrix-of-Mozilla-before-and-after-a-refactor-e760e8-CWCNvB-d.jpeg)
...
## [Look for dependency neighborhoods](#look-for-dependency-neighborhoods)
...
[![Identifying a module in a dependency graph](https://swizec.com/_vercel/image?url=%2Fassets%2FIdentifying-a-module-in-a-dependency-graph-g9f7c0-zj-8UFjI.png&w=960&q=75)](https://swizec.com/assets/Identifying-a-module-in-a-dependency-graph-g9f7c0-zj-8UFjI.png)
...
### [Let the domain guide you](#let-the-domain-guide-you)
...
> 
> — Swizec Teller (@Swizec) [November 20, 2024](https://x.com/Swizec/status/1859056258294444157?ref_src=twsrc%5Etfw)
...
### [How to detangle the domain](#how-to-detangle-the-domain)
...
Filed under: [Scaling Fast Book](https://swizec.com/categories/scaling-fast-book)[Software Engineering](https://swizec.com/categories/software-engineering)[Architectural Complexity](https://swizec.com/categories/architectural-complexity)

## Dive deeper with my books

### Related Articles

*   [Finding modules in a Big Ball of Mud with ChatGPT](https://swizec.com/blog/finding-modules-in-a-big-ball-of-mud-with-chatgpt/)
*   [\*People\* detangle a ball of mud](https://swizec.com/blog/people-detangle-a-ball-of-mud/)
*   [Why even care about code structure](https://swizec.com/blog/why-even-care-about-code-structure/)
*   [Smart core, thin interfaces](https://swizec.com/blog/smart-core-thin-interfaces/)
