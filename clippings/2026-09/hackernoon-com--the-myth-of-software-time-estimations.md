---
url: "https://hackernoon.com/the-myth-of-software-time-estimations-576a7466d91a"
captured_at: "2026-09-25T09:05:04+01:00"
title: "The myth of software time estimations"
...
While there are some obvious exceptions in terms of formal methods and [programs that are provably correct](https://en.wikipedia.org/wiki/Formal_methods?ref=hackernoon.com), the chances are that you haven’t had the time [or found it practical](http://kneuper.de/English/Publications/limits-formal-methods.pdf?ref=hackernoon.com) to implement formal methods and mathematically prove that your program does exactly what it was designed to do in every possible execution state. Even if you have had the time to do this, and you have done it well, up until that very last moment where your program became 100% formally verified, you were wandering around in the dark, reasoning about something that will either run forever without exhibiting any flaws, or will eventually exhibit one or more flaws. In software development, this chaos is normalcy, and wandering around in this unknown, unproven territory where many things could go wrong at any moment _simply is_ the perpetual state of programming.
...
This, I think, is very consistent with the anecdotes of other developers and project managers I have spoken with, and my own experiences — for any given project, the most time-consuming cards in that project were either _vastly underestimated_ or _not anticipated at all_ when the project was first planned and subjected to time estimation. While it is true, especially with large teams of developers, that you can come up with a decent statistical model for _typical_ behavior, this is not useful, as it is overwhelmingly the _unpredictable outliers,_ rather than the known demons, that will dictate how many weeks, months, or years deadlines get pushed back. Add users, multiple developers, human errors, managerial issues, and shifting markets/requirements to the mix, and this unpredictability only increases.

![Sam Johnson's image-99db8](https://hackernoon.imgix.net/images/0*Z6elrVxJm7LjfB8B.gif?auto=format%2Ccompress&w=1920)

A brave project manager tackles time estimations at the beginning of a sprint.

If we accept the premise that software development time estimation is intractable, quixotic, inaccurate, and a waste of time, then an immediate question follows: why does [conventional wisdom](https://www.scrumalliance.org/why-scrum?ref=hackernoon.com) in the industry regularly point to time estimation as a necessary part of the development cycle?
...
In general, you should consider using [pure Kanban](http://kanbanblog.com/explained/?ref=hackernoon.com) without time estimations, but first, you should take the time to write out the following sentence, maybe hang it on your office wall, add it to your mission statement, set it as your development Slack room’s status, and tattoo it to your CTO’s forehead:
...
*   time that has passed since bug was last reported or feature was requested
*   number of users experiencing bug or who have requested feature
*   the value-add this feature/bug-fix provides to the overall product
*   (for bugs) whether the bug has been confirmed/reproduced
*   the importance of the user(s) this bug-fix/feature affects

If you take anything away from this article, at least consider the harm that development time estimations may already be doing to you, your friends, your family, and especially your organization, and consider doing away with time-based estimations, _now_, for good.
