...
captured_at: "2026-09-25T17:16:31+01:00"
...
This content is an excerpt from the eBook, .NET Microservices Architecture for Containerized .NET Applications, available on [.NET Docs](https://learn.microsoft.com/en-us/dotnet/architecture/microservices) or as a free downloadable PDF that can be read offline.

![.NET Microservices Architecture for Containerized .NET Applications eBook cover thumbnail.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/media/cover-thumbnail.png)
...
![Diagram showing the eShopOnContainers architecture.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/eshoponcontainers-architecture.png)
...
We delve into more details in the previous section [Creating composite UI based on microservices](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/architect-microservice-container-applications/microservice-based-composite-ui-shape-layout).
...
![Screenshot of the Services folder showing its subfolders.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/eshoponcontainers-microservice-folders.png)
...
![Screenshot of Solution Explorer showing Catalog.API project contents.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/catalog-api-microservice-folders.png)
...
![Screenshot of Swagger UI showing the Catalog.API REST API.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/test-catalog-microservice.png)
...
![Screenshot of Solution Explorer showing Ocelot API gateway project.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/ocelotapigw-base-project.png)
...
![Diagram of a single Ocelot gateway Docker image for all API gateways.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/reusing-single-ocelot-docker-image.png)
...
![Screenshot showing all API gateways with configuration.json files.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/ocelot-configuration-files.png)
...
![Screenshot of a browser showing a response going through API gateway.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/access-microservice-through-url.png)
...
![Screenshot of a browser showing a direct response to the Catalog.api.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/direct-access-microservice-testing.png)
...
![Diagram of eShopOnContainers architecture showing aggregator services.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/eshoponcontainers-architecture-aggregator-services.png)
...
![Diagram showing eShopOnContainers architecture zoom in.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/zoom-in-vision-aggregator-services.png)
...
In an Ocelot API Gateway, you can sit the authentication service, such as an ASP.NET Core Web API service using [IdentityServer](https://learn.microsoft.com/en-us/dotnet/architecture/cloud-native/identity-server) providing the auth token, either out or inside the API Gateway.
...
![Diagram showing Identity microservice beneath the API gateway.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/eshoponcontainers-identity-service-position.png)
...
![Diagram showing authentication in an Ocelot API Gateway.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/ocelot-authentication.png)
...
When using Kubernetes (like in an Azure Kubernetes Service cluster), you usually unify all the HTTP requests through the [Kubernetes Ingress tier](https://kubernetes.io/docs/concepts/services-networking/ingress/) based on _Nginx_.
...
![A diagram showing how an ingress tier fits into the AKS environment.](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/multi-container-microservice-net-applications/media/implement-api-gateways-with-ocelot/eshoponcontainer-ingress-tier.png)
