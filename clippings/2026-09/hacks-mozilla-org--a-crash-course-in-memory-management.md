...
captured_at: "2026-09-25T09:05:28+01:00"
title: "A crash course in memory management – Mozilla Hacks - the Web developer blog"
domain: "hacks-mozilla-org"
---

_This is the 1st article in a 3-part series:_

1.  _A crash course in memory management_
2.  _[A cartoon intro to ArrayBuffers and SharedArrayBuffers](https://hacks.mozilla.org/2017/06/a-cartoon-intro-to-arraybuffers-and-sharedarraybuffers/)_
3.  _[Avoiding race conditions in SharedArrayBuffers with Atomics](https://hacks.mozilla.org/2017/06/avoiding-race-conditions-in-sharedarraybuffers-with-atomics/)_
...
[![A column of boxes with a child putting something in one of the boxes](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_01-500x353.png)](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_01.png)
...
[![A box with 8 smaller boxes in it](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_02-500x121.png)](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_02.png)
...
[![The number two, converted to binary 00000010 and put inside the boxes](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_03-500x229.png)](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_03.png)
...
[![The letter H, put through an encoder ring to get 72, which is then converted to binary and put in the boxes](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_04-500x277.png)](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_04.png)
...
[![A column of boxes with a rope in front of it and the JS engine standing at that rope like a bouncer](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_05-500x371.png)](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_05.png)

So let’s say some JS code, like React, wants to create a variable.

[![Same as above, with React asking the JS engine to create a variable](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_06-500x373.png)](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_06.png)

What the JS engine does is run that value through an encoder to get the binary representation of the value.

[![The JS engine using an encoder ring to convert the string to binary](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_07-500x370.png)](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_07.png)
...
[![The JS engine finding space for the binary in the column of boxes](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_08-500x367.png)](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_08.png)
...
[![The garbage collector clearing out the memory](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_09-500x379.png)](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_09.png)
...
[![A WebAssembly version of React working with memory directly](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_10-500x360.png)](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_10.png)
...
[![An encoder ring being shipped down as part of the .wasm file](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_11-500x361.png)](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_11.png)
...
[![A free list next to the column of boxes, listing which boxes are free right now](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_12-500x360.png)](https://hacks.mozilla.org/wp-content/uploads/2017/06/01_12.png)
