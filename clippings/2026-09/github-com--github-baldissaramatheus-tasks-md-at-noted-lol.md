---
url: "https://github.com/BaldissaraMatheus/Tasks.md?ref=noted.lol"
captured_at: "2026-09-25T08:53:20+01:00"
title: "GitHub - BaldissaraMatheus/Tasks.md at noted.lol"
domain: "github-com"
---

A self-hosted, Markdown file based task management board.

[![Demo](https://github.com/BaldissaraMatheus/Tasks.md/raw/main/public/demo.gif)](https://github.com/BaldissaraMatheus/Tasks.md/blob/main/public/demo.gif)
...
[](#upgrade-from-2xx-to-3xx)

If you're running a docker container with version 2 of Tasks.md and want to upgrade it to version 3, please follow up [those instructions](https://github.com/BaldissaraMatheus/Tasks.md/blob/main/migration-guide.md) as it requires some tweeks for it to work properly.
...
*   `BASE_PATH`: Base path in the url. Use this variable if you are going to run the app under a subpath based reverse-proxy. Be aware that PWA does not work when BASE\_PATH is set with anything other than "/";
...
[![Screenshot of the app. There are 3 lanes, Backlog, Sprint and Done. Within Done there is one file named "Something something"](https://github.com/BaldissaraMatheus/Tasks.md/raw/main/public/directories-organization-1.png)](https://github.com/BaldissaraMatheus/Tasks.md/blob/main/public/directories-organization-1.png)

#### Your files should look like this:

[](#your-files-should-look-like-this)

[![Screenshot of a file explorer showing 3 folders: Backlog, Sprint and Done](https://github.com/BaldissaraMatheus/Tasks.md/raw/main/public/directories-organization-2.png)](https://github.com/BaldissaraMatheus/Tasks.md/blob/main/public/directories-organization-2.png) [![Screenshot of file explorer within a folder called "Done", containing one file named "Something something"](https://github.com/BaldissaraMatheus/Tasks.md/raw/main/public/directories-organization-3.png)](https://github.com/BaldissaraMatheus/Tasks.md/blob/main/public/directories-organization-3.png)
