...
captured_at: "2026-09-25T17:15:02+01:00"
...
**Edit:** I’ve never been happier to be wrong! Turns out injecting import maps via DOM methods actually works in all browsers (as long as it is done by a non-module script that runs before any modules are fetched)! In fact, [JSPM 4.0](https://jspm.org/jspm-4.0-release) uses it! 🎉 This is a _gamechanger_.
