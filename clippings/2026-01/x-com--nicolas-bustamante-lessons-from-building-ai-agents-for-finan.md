...
captured_at: "2026-01-26T15:06:22+00:00"
...
](https://x.com/nicbstme/article/2015174818497437834/media/2015173519529984000)
...
](https://x.com/nicbstme/article/2015174818497437834/media/2015173594935074816)
...
](https://x.com/nicbstme/article/2015174818497437834/media/2015173725801619456)
...
](https://x.com/nicbstme/article/2015174818497437834/media/2015174088579284992)
...
SELECT user\_id, path, metadata

WHERE user\_id = ANY(:user\_ids)
...
4\. Metadata-driven filtering. The \`fs\_files.metadata\` column stores parsed YAML frontmatter. We can filter by skill type, check if a skill is main-agent-only, or query any other structured attribute—all without reading the files themselves.
...
fs-sync Lambda → Upsert/delete in fs\_files table (real-time)
...
org\_memories, user\_memories = await fetch\_memories(safe\_user\_id, org\_id)

conversation\_manager.add\_backend\_message(
...
](https://x.com/nicbstme/article/2015174818497437834/media/2015174241126367232)

WriteFile creates artifacts that link back to the UI:

\# Files in /private/artifacts/ become clickable links

\# computer://user\_id/artifacts/chart.png → opens in viewer
...
](https://x.com/nicbstme/article/2015174818497437834/media/2015174411003834368)
...
](https://x.com/nicbstme/article/2015174818497437834/media/2015174459255332864)
...
](https://x.com/nicbstme/article/2015174818497437834/media/2015174680236392448)
