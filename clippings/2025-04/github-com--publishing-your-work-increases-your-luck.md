...
captured_at: "2025-04-02T11:05:54-03:00"
title: "Publishing your work increases your luck · GitHub"
domain: "github-com"
---
...
The goal is not to become famous, the goal is to increase the chances of luck finding us. For me, one of the most helpful ways to think about this has always been the concept of the “Luck Surface Area,” described in an [<u>old post by Jason Roberts</u>](https://www.codusoperandi.com/posts/increasing-your-luck-surface-area). He wrote (and note, the emphasis is mine): 

_"The amount of serendipity that will occur in your life, your Luck Surface Area, is directly proportional to the degree to which you_ _**do something**_ _you’re passionate about combined with the total number of people to whom this is_ _**effectively communicated**__."_

Going further, he codifies it into a formula where:

```
<span><span>Luck</span> <span>=</span> <span>[</span><span>Doing</span> <span>Things</span><span>]</span> <span>*</span> <span>[</span><span>Telling</span> <span>People</span><span>]</span></span>
```
...
The more things you do multiplied by the more people you tell, the larger your Luck Surface Area becomes. The larger your Luck Surface Area, the more likely you are to catch luck as it flows by.
   ...
   ![A graph with "Doing" on the Y axis, and "Telling" on the X axis. The more you do and tell, the better.](https://images.ctfassets.net/s5uo95nf6njh/1mf4WuCw33UGsrQTdkErFe/1b5c74f7b54deb664b6bb39aa6303d35/AF_inline.jpg?w=468&fm=jpg)

### Source: [<u> Jason Roberts</u>](https://www.codusoperandi.com/posts/increasing-your-luck-surface-area)

___

## Doing the work

Before you can publish your work, you have to actually _do_ the work. The good news for you is that by even reading this Guide on The ReadME Project, you’ve probably already self-selected into a group of people for whom “doing things” comes somewhat naturally. You’re a developer, a designer, a creator, an author, or something else entirely.  Whatever moniker you want to give yourself, you’re built to _do_ things, and that’s the important part. 

If that doesn’t ring true for you, you may fall into one of two groups:

1.  You actually _are_ doing things, you’ve just trained yourself to think that anything you do isn’t worth sharing.
    
2.  You _want_ to be doing things, but you can’t bring yourself to get started.
...
-   If you want to make [<u> a thermal receipt printer that prints GitHub issues</u>](https://twitter.com/aschmelyun/status/1506960015063625733), you should. 
    
-   If you want to [<u> turn a prefabricated shed into an office</u>](https://twitter.com/aarondfrancis/status/1333866090573811723), go for it. 
    
-   If you want to go all in on an [<u> SVG drawing tool</u>](https://twitter.com/steveruizok/status/1419048412431933441), do it. 
    
-   If you want to write tens of thousands of words about [<u>the infrastructure of modern money</u>](https://bam.kalzumeus.com/archive/), that’s a newsletter. 
...
Don’t be afraid to publish along the way. You don’t have to wait until you’re done to drop a perfect, finished artifact from the sky (in fact, you may use that as an excuse to _never_ publish). People like stories, so use that to your benefit. Share the wins, the losses, and the thought processes. Bring us along! If you haven’t been in the habit of sharing your work, it’s going to feel weird when you start. That’s normal! Keep going, you get used to it. 

You’ve done the work. You’ve hit the publish button. You’ve done your part! 

## Capturing the luck

You’ve _increased the odds_ that good, unexpected things will come your way. The exact form is hard to predict, but here are a few potential outcomes: 
