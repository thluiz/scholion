...
captured_at: "2025-07-17T13:19:57+01:00"
title: "Local-first software: You own your data, in spite of the cloud"
domain: "inkandswitch-com"
---

---
## [Motivation: collaboration and ownership](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#motivation-collaboration-and-ownership)
...
## [Seven ideals for local-first software](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#seven-ideals-for-local-first-software)
...
### [1\. No spinners: your work at your fingertips](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#1-no-spinners-your-work-at-your-fingertips)
...
### [2\. Your work is not trapped on one device](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#2-your-work-is-not-trapped-on-one-device)
...
### [4\. Seamless collaboration with your colleagues](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#4-seamless-collaboration-with-your-colleagues)
...
In local-first apps, our ideal is to support real-time collaboration that is on par with the best cloud apps today, or better. Achieving this goal is one of the biggest challenges in realizing local-first software, but we believe it is possible: in a [later section](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#towards-a-better-future) we discuss technologies that enable real-time collaboration in a local-first setting.
...
### [5\. The Long Now](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#5-the-long-now)
...
### [6\. Security and privacy by default](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#6-security-and-privacy-by-default)
...
### [7\. You retain ultimate ownership and control](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#7-you-retain-ultimate-ownership-and-control)
...
With data ownership comes responsibility: maintaining backups or other preventative measures against data loss, protecting against ransomware, and general organizing and managing of file archives. For many professional and creative users, as introduced in [the introduction](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#motivation-collaboration-and-ownership), we believe that the trade-off of more responsibility in exchange for more ownership is desirable. Consider a significant personal creation, such as a PhD thesis or the raw footage of a film. For these you might be willing to take responsibility for storage and backups in order to be certain that your data is safe and fully under your control.

## [Existing data storage and sharing models](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#existing-data-storage-and-sharing-models)
...
### [How application architecture affects user experience](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#how-application-architecture-affects-user-experience)

Let’s start by examining software from the end user’s perspective, and break down how well different software architectures meet the [seven ideals for local-first software](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#seven-ideals-for-local-first-software). In the [next section](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#developer-infrastructure-for-building-apps) we compare storage technologies and APIs that are used by software engineers to build applications.

#### [Files and email attachments](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#files-and-email-attachments)
...
-   Using a cloud file storage service like [Dropbox, Google Drive, or OneDrive](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#dropbox-google-drive-box-onedrive-etc);
-   Using a version control system such as [Git](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#git-and-github).
...
#### [Web apps: Google Docs, Trello, Figma, Pinterest, etc.](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#web-apps-google-docs-trello-figma-pinterest-etc)
...
#### [Dropbox, Google Drive, Box, OneDrive, etc.](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#dropbox-google-drive-box-onedrive-etc)
...
### [Developer infrastructure for building apps](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#developer-infrastructure-for-building-apps)
...
#### [Web app (thin client)](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#web-app-thin-client)
...
#### [Mobile app with local storage (thick client)](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#mobile-app-with-local-storage-thick-client)
...
#### [Backend-as-a-Service: Firebase, CloudKit, Realm](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#backend-as-a-service-firebase-cloudkit-realm)
...
#### [CouchDB](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#couchdb)
...
## [Towards a better future](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#towards-a-better-future)
...
### [CRDTs as a foundational technology](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#crdts-as-a-foundational-technology)
...
### [Ink & Switch prototypes](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#ink-switch-prototypes)
...
#### [Kanban board](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#kanban-board)
...
#### [Collaborative drawing](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#collaborative-drawing)
...
#### [Media canvas](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#media-canvas)
...
#### [Findings](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#findings)
...
### [How you can help](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#how-you-can-help)
...
#### [For distributed systems and programming languages researchers](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#for-distributed-systems-and-programming-languages-researchers)
...
#### [For Human-Computer Interaction (HCI) researchers](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#for-human-computer-interaction-hci-researchers)
...
#### [For practitioners](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#for-practitioners)
...
#### [Call for startups](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#call-for-startups)
...
## [Conclusions](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#conclusions)
...
### [Acknowledgments](https://www.inkandswitch.com/essay/local-first/?ref=weeklyfoo#acknowledgments)
